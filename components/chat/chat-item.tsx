...
import { Edit, EditIcon, File, FileIcon, ShieldAlert, ShieldCheck, Trash } from "lucide-react";
...
const ChatItem = ({
    ...
    const isPDF  = "pdf" === fileType && fileUrl;
                    ...
                    {canEditMessage && (
                        <ActionTooltip label="Edit">
                            <Edit
                                ...
                                className=" cursor-pointer ml-auto w-4 h-4 text-zinc-500 hover:text-zin-600 dark:hover:text-zinc-300 transition"
                            />
                        </ActionTooltip>
                    )}
                    {canDeleteMessage && (
