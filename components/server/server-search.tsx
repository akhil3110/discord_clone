    ...
    return ( 
        <>
            ...
            >
                ...
                <kbd
                    className=" pointer-events-none inline-flex h-5 select-none items-center gap-1 border rounded bg-muted px-1.5 font-mono text-[10px] font-medium text-muted-foreground  ml-auto"
                >
            ...
            <CommandDialog open={open} onOpenChange={setOpen}>
                <CommandInput 
                    placeholder="search all channel and members"
                />
                <CommandList>
                    <CommandEmpty>
                        No Results Found
